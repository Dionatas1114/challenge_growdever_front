...
import { Delete, FilterList, Lock, LockOpen } from '@material-ui/icons';
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  const messages = {
                    'classAvaliable': 'Disponível',
                    'alreadyRegistered': 'Você já está incrito(a)'
                  }
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align={row.status.numeric ? 'right' : 'left'}>
                        {row.status ? [messages.alreadyRegistered, <Lock color='action'/>] : [messages.classAvaliable, <LockOpen color='primary'/>]}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
        ...
        <TablePagination
          rowsPerPageOptions={[5, 10, 25, 50, 75, 100, 150]}
          component="div"
          count={rows.length}
